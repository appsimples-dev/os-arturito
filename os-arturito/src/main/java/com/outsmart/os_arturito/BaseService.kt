...
open class BaseService {
    ...
    companion object {
        ...
        fun <ApiModel : BaseApiModel<AppModel>, AppModel> makeApiCallCompletable(
                remote: Single<OSResponse<ApiModel>>,
                local: ((appModel: AppModel) -> Completable)? = null): Completable {
        ...
        fun <ApiModel : BaseApiModel<AppModel>, AppModel> makeApiCallSingle(
                remote: Single<OSResponse<ApiModel>>,
