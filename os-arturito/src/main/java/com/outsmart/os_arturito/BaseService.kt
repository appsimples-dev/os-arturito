...
open class BaseService {
    ...
    companion object {
                ...
                remote.subscribeOn(Schedulers.io())
                        ...
                        .subscribe({ response ->
                            ...
                            if (t is HttpException) {
                                ...
                                it.onError(
                                        OSError(t.javaClass.toString(),
                                                "Ocorreu um erro desconhecido, por favor tente novamente mais tarde",
                                                "An error ocurred while making the request. This message was thrown at the BaseService from os-arturito. Details: ${t}"
        ...
        private fun listenError(exception: HttpException): OSError {
            ...
            var error = OSError(exception.message(), exception.localizedMessage, "The error returned by the backend was not recognized to be generated by Outsmart backend. Details: ${exception}")
            try {
